...
const roleRoutes: Record<string, string[]> = {
  admin: ['/admin'],
  doctor: ['/doctor', '/my-queue', '/patients', '/consultations', '/prescriptions'],
  nurse: ['/nurse', '/screening', '/patients', '/vitals', '/notes'],
  receptionist: ['/reception', '/queue', '/patients', '/appointments'],
}
